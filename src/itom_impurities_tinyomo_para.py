...
This module defines:
	...
	- the `itom_hub_retrofit_impurities_tinyomo_para` class that extends the class `itom_hub_retrofit_tinyomo_para`
	  which replaces a Pyomo ABSTRACT and CONCRETE model definition using classes from tinyomo_para

@author: mathieusa, alexanderkl
"""

__all__ = ('itom_hub_retrofit_impurities_tinyomo_para',)

from tinyomo_para import NonNegativeReals, Reals, Set, Param, Var, Constraint
from itom_retrofit_tinyomo_para import itom_hub_retrofit_tinyomo_para


class itom_hub_retrofit_impurities_tinyomo_para(itom_hub_retrofit_tinyomo_para):
	"""
