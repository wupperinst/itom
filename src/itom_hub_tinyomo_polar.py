...
This module defines:
    ...
    - the `itom_hub_tinyomo_polar` class that replaces a Pyomo ABSTRACT and CONCRETE model definition using classes from tinyomo_polar
...
__all__ = ('itom_hub_tinyomo_polar',)

# from __future__ import division
import os
import numpy as np
from tinyomo_polar import Sets, Set, Params, Param, Vars, Var, Constraints, Constraint, Objective
from tinyomo_polar import NonNegativeReals, Reals
from tinyomo_polar import write_objective, write_constraints, write_bounds, write_lp
from tinyomo_polar import write_variables_overview, write_variables, write_constraints_overview
from tinyomo_polar import write_objective_likepyomo, write_constraints_likepyomo, write_bounds_likepyomo, write_lp_likepyomo
from tinyomo_polar import write_parameters


##############################################################################

class itom_hub_tinyomo_polar(object):
    '''
