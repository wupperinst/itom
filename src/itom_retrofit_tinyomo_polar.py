...
This module defines:
	...
	- the `itom_hub_retrofit_tinyomo_polar` class that extends the class `itom_hub_tinyomo_polar`
	  which replaces a Pyomo ABSTRACT and CONCRETE model definition using classes from tinyomo_polar

@author: mathieusa
'''

__all__ = ('itom_hub_retrofit_tinyomo_polar',)

from tinyomo_polar import Set, Param, Vars, Var, Constraints, Constraint
from tinyomo_polar import NonNegativeReals

from itom_hub_tinyomo_polar import itom_hub_tinyomo_polar

class itom_hub_retrofit_tinyomo_polar(itom_hub_tinyomo_polar):
	"""
